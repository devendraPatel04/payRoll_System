...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        ImageIcon i1 = new ImageIcon("src/icon/payroll.jpg");
        Image i2 = i1.getImage().getScaledInstance(1367,728,Image.SCALE_DEFAULT);
        ...
        t1.setIcon(new ImageIcon("src/Icons/New.png"));
    
        JMenuItem t3 = new JMenuItem("Salary");
        t3.setForeground(Color.blue);
        t3.setFont(new Font("monospaced",Font.PLAIN,12));
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon("src/icon/schedreport.png"));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon("src/icon/newinvoice.png"));
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon("src/Icons/EditOpen.png"));
        ...
        s2.setMnemonic('p');
        s2.setIcon(new ImageIcon("src/icon/empreport.png"));
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon("src/icon/EXPENSE.PNG"));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon("src/icon/payments.png"));
        ...
        p2.setMnemonic('L');
        p2.setIcon(new ImageIcon("src/icon/empreport.png"));
        ...
        u1.setIcon(new ImageIcon("src/Icons/New.png"));
        ...
        util.add(u1);
        JMenuItem u2 = new JMenuItem("AnyDesk");
        u2.setIcon(new ImageIcon("src/icon/calc.png"));
  
        u2.setForeground(Color.blue);
        u2.setFont(new Font("monospaced",Font.PLAIN,12));
        u2.setMnemonic('A');
        u2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, ActionEvent.SHIFT_MASK));
 
        util.add(u2);
        JMenuItem u3 = new JMenuItem("Web Browser");
        u3.setIcon(new ImageIcon("src/icon/explorer.jpg"));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon("/srcicon/exit.PNG"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("AnyDesk")){
            try{
               Runtime.getRuntime().exec("C:\\Users\\dev\\Downloads\\AnyDesk.exe");
            }catch(Exception e){ }
        }
        ...
        if(msg.equals("Take Attendence")){
            new TakeAttendence().setVisible(true);
        }
        
        if(msg.equals("Generate PaySlip"))
            new pay_slip().setVisible(true);
        
        if(msg.equals("List Attendence"))
